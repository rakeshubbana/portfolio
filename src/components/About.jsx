  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={`text-[#020810a1] ${styles.sectionSubText} mt-10  `}>
          Introduction
        </p>
      </motion.div>
      <motion.p
        variants={fadeIn("", "", 0.1, 1)}
        className=" text-[#020810a1] text-[13px]"
      >
        I'm an expert software developer with expertise in Java, Javascript,
        Node.js, React.js. I am quick to pick things up and work closely with
        customers to create solutions that are practical, scalable, and
        user-friendly. Let's work together to bring your ideas to life.
      </motion.p>
      <br />
