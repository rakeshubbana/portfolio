  ...
  const sendEmail = () => {
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Rakesh Ubbana",
          from_email: form.email,
          to_email: "rakeshubbana30@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert(
            "Thank you for reaching me. I will get back to you as soon as possible."
          );
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex-[0.75] max-sm:mt-28 bg-[#0f8f96] form  p-8 rounded-2xl"
      >
        ...
        >
          ...
          <button
            type="submit"
            className="bg-green-700 py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-secondary"
